...
past_participle = {
    ...
    'middle': (
        ...
        'mistaken', 'rung', 'risen', 'sold', 'sent', 'shaken', 'shut', 'sung', 'sunk', 'spent', 'sprung', 'stolen', 'swum',
...
rus = {
    'low': (
        ...
        'Бороться', 'Находить', 'Летать', 'Получать', 'Давать', 'Идти', 'Иметь', 'Слышать', 'Знать', 'Учить',
        ...
        'Говорить', 'Стоять', 'Учить', 'Рассказывать', 'Носить', 'Писать'
    ),
    'middle': (
